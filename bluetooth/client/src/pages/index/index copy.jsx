...
export default class Index extends Component {
  ...
  async componentWillMount () {
    ...
    const { connectedCollapse, unconnectedCollapse, connectDevices } = userInfo
    // 初始化蓝牙模块
  ...
  render () {
    return (
      <View className='index' style={{
        ...
        {/* 列表为空的时候展示页面 */}
        {
          (this.state.unConnectedList.length === 0 && this.state.onLineList.length === 0 &&
            this.state.connectedList.length === 0) &&
